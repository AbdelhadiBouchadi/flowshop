      ...
      <div className="flex flex-col gap-10">
        {banner && (
          <div className="relative hidden sm:block">
            ...
            />
            <div className="absolute inset-0 rounded-md bg-gradient-to-b from-transparent via-transparent to-black" />
        ...
        <div
          className={cn(
            "flex items-center rounded-md bg-primary/30 py-8 shadow-md",
            banner && "sm:hidden",
          )}
        >
          <h1
            className={cn(
              "mx-auto text-4xl font-bold text-secondary-foreground",
              banner && "sm:hidden",
            )}
          >
            {collection.name}
